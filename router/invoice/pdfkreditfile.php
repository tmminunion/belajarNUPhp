...
class pdfkreditfile extends invoiceModel
{
    public function donasi($id)
    {
        ...
        $this->pdfrenderfile('invoice/simplepdf', $data);
    }
    public function tabungan($id)
    {
        ...
        $data['base64'] = $this->textcode();
        $this->pdfrenderfile('invoice/pdftabung', $data);
    }
    public function kas($id)
    {
        ...
        $data['base64'] = $this->textcode();
        $pdfFilePath = '/cache/invoice.pdf';
        $this->pdfrenderfile('invoice/pdftabung', $data,$pdfFilePath);
    }

    private function textcode()
    {
